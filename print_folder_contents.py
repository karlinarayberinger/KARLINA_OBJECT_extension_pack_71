...
folder_path = 'karbytes2026_7'  # Replace the value of folder_path with your actual folder path.
output_file = 'karbytes2026_7_contents.txt'  # Replace the value of output_file with your preferred output text file path (which will overwrite that file if it exists or else generate it).
